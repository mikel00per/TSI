(define (problem ejercicio6)
  ...
  (:init
    (= (mochila mkxv) 0)
    (= (tam-maximo-mochila mkxv) 5)
    (= (coste-t mkxv) 0)
    (= (beneficio mkxv) 0)
    (= (num-objetos-entregados mkxv) 0)
    ...
    (posicion Bruja z1)
    (posicion Principe z1)
    (posicion Leonardo z1)
    (posicion Princesa z1)
    (posicion Profesor z1)

    (posicion oro z3)
    (posicion rosa z3)
    (posicion oscar z3)
    (posicion manzana z3)
    (posicion algoritmo z3)

    (posicion zapatillas z1)  (posicion bikini z2)
    ...
    (es-arena z14)        (es-arena z15)
    (es-arena z16)        (es-arena z17)
    (es-precipicio z18)   (es-precipicio z19)
