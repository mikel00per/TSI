(define (problem ejercicio3)
  ...
  (:init
    ...
    (posicion oro z1)     (posicion rosa z2)
    (posicion oscar z3)   (posicion algoritmo z0)
    (posicion manzana z4)
    ...
    (posicion oro z23)         (posicion rosa z22)
    (posicion oscar z4)       (posicion manzana z1)
    (posicion algoritmo z4)
